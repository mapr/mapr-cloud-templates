...
STANZA_URL="https://raw.githubusercontent.com/mapr/mapr-cloud-templates/master/1.11/azure/marketplace/mapr-core.yml"
STATUS="SUCCESS"
...
EOM
    ...
    CMD="$CLI import --no_check_certificate --config -f -t $INPUT -u $MAPR_USER:$MAPR_PASSWORD@localhost:9443"
